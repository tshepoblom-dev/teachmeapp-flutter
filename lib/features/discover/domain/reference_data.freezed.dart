...
class _$InstitutionImpl implements _Institution {
  ...
  @override
  String toString() {
    return 'Institution(id: $id, name: $name, abbreviation: $abbreviation, type: $type)';
  }
...
class _$SubjectImpl implements _Subject {
  ...
  @override
  String toString() {
    return 'Subject(id: $id, name: $name, code: $code, faculty: $faculty, institutionId: $institutionId)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, code, faculty, institutionId);
